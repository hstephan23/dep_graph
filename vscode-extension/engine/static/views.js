...
function switchView(view) {
    ...
    function _updateToolbar() {
        const graphOnly = document.querySelectorAll('#folderColorKey, #graphStatusBar, #pathHint, #minimap, .input-search-controls, #fisheyeToggle, #pdViewToggle');
        graphOnly.forEach(el => el.style.display = isGraph ? '' : 'none');
        if (view === 'layers') {
            const hide = document.querySelectorAll('#fisheyeToggle, #pdViewToggle, #minimap');
