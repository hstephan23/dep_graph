...
export function activate(context: vscode.ExtensionContext) {
  ...
  if (config.autoRefresh) {
    const watcher = vscode.workspace.createFileSystemWatcher('**/*.{py,js,ts,jsx,tsx,java,go,rs,c,cpp,h,hpp,cs,swift,rb,kt,kts,scala,sc,php,dart,ex,exs,lua,zig,hs,R,r}');
